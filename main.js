...
console.log(`Before calling the method, the crust is ${pizzaObj.pizza.crust}`);
pizzaObj.setCrust("Thick");
console.log(`After calling the method, the crust has been modified to ${pizzaObj.pizza.crust}`);
